...
public class FieldOfView : MonoBehaviour
{
    ...
    void DrawFieldOfView()
    {
        ...
        for (int i = 0; i <= stepCount; i++)
        {
            ...
            if (i > 0)
            {
                bool edgeDistanceThressholdExceeded = Mathf.Abs(oldViewCast.dst - newViewCast.dst) > edgeDistanceThresshold;
                if (oldViewCast.hit != newViewCast.hit || (oldViewCast.hit && newViewCast.hit && edgeDistanceThressholdExceeded))
                {
        ...
        vertices[0] = Vector3.zero;//local space of the gameObject
    ...
    private EdgeInfo FindEdge(ViewCastInfo minViewCast, ViewCastInfo maxViewCast)
    {
        ...
        for (int i = 0; i < edgeResolveIteration; i++)
        {
            ...
            bool edgeDistanceThressholdExceeded = Mathf.Abs(minViewCast.dst - newViewCast.dst) > edgeDistanceThresshold;
            if (newViewCast.hit == minViewCast.hit && !edgeDistanceThressholdExceeded)
            {
                minAngle = angle;
